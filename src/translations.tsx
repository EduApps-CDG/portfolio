...
export class TranslationHelper {
  protected PT:typeof this.EN = {
    ...
    portfolio: <>Pesquisei muito ao fazer este portfolio, pois eu-o programei para ter uma alta pontuação no Google. O nome de domínio foi providenciado gratuitamente por <a href="https://freedns.afraid.org" target="_blank">FreeDNS</a> e o código feito em React com Next.js. A ideia era testar minhas habilidades, me surpreendi com o resultado ao perceber que o website funciona até em celulares abre-fecha.</>
  };
  ...
  protected EN:{[index:string]:JSX.Element} = {
    ...
    portfolio: <>I did a lot of research when making this portfolio, as I programmed it to rank highly on Google. The domain name was provided by <a href="https://freedns.afraid.org" target="_blank">FreeDNS</a> and the code was done in React with Next.js. The idea was to test my skills, I was surprised with the result when I realized that the website even works on open-close cell phones.</>
  };
