...
export class TranslationHelper {
  protected PT:typeof this.EN = {
    ...
    welcome_3: <>Desenvolvedor Fullstack com experiência em PHP e JavaScript. Estou sempre buscando criar um mundo melhor através da tecnologia.</>,
    about_me: <>Sobre mim</>,
  ...
  protected EN:{[index:string]:JSX.Element} = {
    ...
    welcome_3: <>Fullstack developer with experience in PHP and JavaScript. I'm always striving to create a better world through technology.</>,
    about_me: <>About me</>,
