  ...
  public render() {
    return <>
      <div className="contact-icon">
        ...
        <StandardIcon path={mdiPhone} href="tel:+5551993763209"/>
        <StandardIcon path={mdiWhatsapp} href="https://api.whatsapp.com/send?phone=5551993763209&text=Bom%20dia%2C%20Eduardo!"/>
